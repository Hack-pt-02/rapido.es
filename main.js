        ...
        gsap.to(".hero_title", {x: 300, duration: 1.5, opacity: 1, ease: Power3.easeOut});

        gsap.to(".hero_description", {x: 300, duration: 1.5, opacity: 1, delay: 0.8,ease: Power3.easeOut});

        gsap.to(".hero_logo", {y: 20, duration: 1.5, opacity: 1, ease: Power3.easeOut})

        gsap.to(".hero_login", {y: 20, duration: 1.5, opacity: 1, ease: Power3.easeOut})
